...
/* Jay R -- Added 02-15-2011 UPOS 1.13 Compliance -- Start */
const LONG BIO_SUE_MOVE_SLOWER          = 10;
const LONG BIO_SUE_MOVE_FASTER          = 11;
const LONG BIO_SUE_SENSOR_DIRTY         = 12;
const LONG BIO_SUE_FAILED_READ          = 13;
const LONG BIO_SUE_SENSOR_READY         = 14;
const LONG BIO_SUE_SENSOR_COMPLETE      = 15;
/* Jay R -- Added 02-15-2011 UPOS 1.13 Compliance -- End */
